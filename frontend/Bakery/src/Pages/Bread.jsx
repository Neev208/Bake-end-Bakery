...
import { productData } from "../data"; // Keeping your import

const Bread = () => {
  // Filter for ONLY Bread items
  const products = productData.filter((p) => p.cat === "Bread & Rolls");
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white pt-32 pb-24 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto mb-16">
        ...
        <p className="text-gray-400 mt-6 text-lg">
          Artisan sourdough and baguettes, fermented for 48 hours.
        </p>
      </div>
            ...
            >
              <div className="aspect-[4/5] overflow-hidden rounded-[2rem] bg-neutral-900 border border-white/5 relative">
                ...
                <div className="absolute top-6 right-6 bg-black/40 backdrop-blur-xl border border-white/10 px-4 py-2 rounded-full font-bold">
                  {/* This displays whatever string is in your data file (e.g. "$8" or "₹450") */}
                  {product.price}
                </div>
              </div>
              <div className="mt-6 flex justify-between items-start px-2">
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">{product.cat}</p>
                </div>
